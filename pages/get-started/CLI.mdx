...
A desktop app will be available soon, stay tuned!
...
This will allow you to run beeker CLI in your project with command `npm run beeker` or `yarn beeker` or `pnpm run beeker`.
