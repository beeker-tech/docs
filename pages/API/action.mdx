...
| parallelize                  | Set to true if rules should be applied in parallel, of false if it should be applied sequentially. (true by default) | ✘        |
...
| default_value | The default value of the variable, displayed in input placeholders of beeker apps. | ✘        |
